              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: "Email", // Placeholder text when the field is empty
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(30), // Rounded corners for focused state
                      borderSide: BorderSide(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(30), // Same rounded corners for enabled state
                      borderSide: BorderSide(
                    ...
                    errorBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(30), // Rounded corners for error state
                      borderSide: BorderSide(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        if (_validateEmail(_emailController.text)) {
                          ...
                          setState(() {
                            _emailError = 'Please enter a valid email address'; // Show error
                          });
                        }
                      },
